...
<head>
    ...
    <title> Welcome to Kunjungan Industri</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
        <div class="container-fluid hover">
            <a class="navbar-brand fs-2 fw-bold" href="#Home">Kunjungan Industri</a>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3>BK</h3>
                        <p class="lead mb-0">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
    ...
    <section class="testimonials text-center bg-light">
        <div class="container" id="Customer">
            <h2 class="mb-5">Our Valuable Customer</h2>
            <div class="row">
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="assets/img/testimonials-1.jpg" alt="..." />
                        <h5>Politeknik Negeri Jember</h5>
                        <p class="font-weight-light mb-0">"Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups."</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
    ...
    <section class="call-to-action text-white text-center">
        <div class="container position-relative" id="ContactUs">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <h2 class="mb-4">(021) 79187686</h2>

                    <h3 class="mb-4"> atau </h3>

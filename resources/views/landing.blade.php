...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-auto social-icons">
                    <a href="https://wa.me/6289616658515"><i class='bx bxl-whatsapp'></i></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">Kunjungan Industri<span class="dot">.</span></a>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service">
                        ...
                        <h5>Miniatur Simulasi Instalasi FO</h5>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                            classical Latin literature from</p>
                    </div>
                </div>
    ...
    <footer>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h4 class="navbar-brand">Kunjungan Industri<span class="dot">.</span></h4>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                            classical Latin literature from</p>
                        <div class="col-auto social-icons">
                          <a href="https://wa.me/6289616658515"><i class='bx bxl-whatsapp'></i></a>
        ...
        <div class="footer-bottom text-center">
            <p class="mb-0">Copyright siXeyes Tech 2022. All rights Reserved</p> Distributed By <a
                hrefs="https://themewagon.com">Icon+ KP Yogyakarta</a>
        </div>
    </footer>
